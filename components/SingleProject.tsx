  ...
  return (
    <div className=' rounded-lg flex flex-col-reverse md:flex-row'>
        <div className=' p-10 w-full h-96 '>
            ...
            {deplyedData?<Link className=' mb-4 flex justify-center items-center w-fit px-4 py-3 gap-2 hover:text-sky-900 bg-gray-200 rounded-lg text-lg font-medium' href={deplyedData}>Deployed Link <FiExternalLink /></Link>:null}
